...
INTERNAL_IPS = get_list(os.environ.get("INTERNAL_IPS", "127.0.0.1","*","wemarketplace.herokuapp.com"))
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1.wemarketplace.herokuapp.com"))
